...
Este documento lista todos los shortcodes disponibles en el tema Elementor Blank Starter.

---

## Shortcodes de GAL/GDR

### `[galgdr_siglas]`
Muestra las siglas del GAL/GDR actual.
- **Uso:** `[galgdr_siglas]`
- **Contexto:** Dentro de una página de GAL/GDR
- **Retorna:** Texto de las siglas (ej: "ADIMAN")

---

## Shortcodes de Municipio

### `[municipio_galgdr_name]`
Muestra el nombre del GAL/GDR asociado a un municipio.
...
- **Retorna:** Nombre del GAL/GDR asociado
...
### `[breadcrumbs]`
Muestra breadcrumbs (migas de pan) de navegación.
- **Uso:** `[breadcrumbs]`
- **Características:**
  - Trunca títulos largos a 60 caracteres respetando palabras completas
...
### Municipio
- `_municipio_galgdr_asociado` - ID del GAL/GDR asociado (integer)

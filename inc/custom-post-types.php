 ...
 */
function elementor_blank_post_title_shortcode($atts) {
...
add_shortcode('post_title', 'elementor_blank_post_title_shortcode');

/**
 * Shortcode to convert term ID to name
 * Usage: [term_name id="123" taxonomy="provincia"]
 */
function elementor_blank_term_name_shortcode($atts) {
 ...
 */
function elementor_blank_proyectos_gdr_link_shortcode($atts) {
...
function elementor_blank_add_proyectos_provincia_meta_box() {
    ...
    add_meta_box(
        'proyectos_municipio',
        __('Municipio', 'elementor-blank-starter'),
    ...
    add_meta_box(
        'proyectos_ayuda',
        __('Ayuda', 'elementor-blank-starter'),
        'elementor_blank_proyectos_ayuda_callback',
        'proyectos',
        'side',
        'default'
    );
...
function elementor_blank_proyectos_gdr_callback($post) {
    ...
    echo '<label for="proyectos_gdr_select">' . __('Selecciona GDR:', 'elementor-blank-starter') . '</label><br>';
 ...
 */
function elementor_blank_remove_from_noticias_slider($post_id) {

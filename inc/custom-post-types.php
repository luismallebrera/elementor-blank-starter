...
function elementor_blank_register_gdrs_cpt() {
    ...
    $labels = array(
        ...
        'attributes'            => __('GAL/GDR Attributes', 'elementor-blank-starter'),
        'parent_item_colon'     => __('Parent GAL/GDR:', 'elementor-blank-starter'),
        ...
        'view_items'            => __('Ver GAL/GDR', 'elementor-blank-starter'),
        ...
        'insert_into_item'      => __('Insertar en GAL/GDR', 'elementor-blank-starter'),
        'uploaded_to_this_item' => __('Subido a este GAL/GDR', 'elementor-blank-starter'),
        ...
        'filter_items_list'     => __('Filtrar lista de GAL/GDR', 'elementor-blank-starter'),
    );

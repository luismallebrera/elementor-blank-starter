 ...
 */
function elementor_blank_rename_on_set_thumbnail( $meta_id, $post_id, $meta_key, $meta_value ) {
...
add_action( 'added_post_meta', 'elementor_blank_rename_on_set_thumbnail', 10, 4 );
add_action( 'updated_post_meta', 'elementor_blank_rename_on_set_thumbnail', 10, 4 );

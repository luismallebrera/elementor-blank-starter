 ...
 */
function elementor_blank_portfolio_title_color_shortcode( $atts ) {
...
add_shortcode( 'portfolio_title_color', 'elementor_blank_portfolio_title_color_shortcode' );
 ...
 */
function elementor_blank_portfolio_title_color_class_shortcode( $atts ) {
	$atts = shortcode_atts( array(
		'post_id' => get_the_ID(),
		'default' => 'light',
		'prefix'  => 'title-',
...
add_shortcode( 'portfolio_title_color_class', 'elementor_blank_portfolio_title_color_class_shortcode' );
 ...
 */
function elementor_blank_portfolio_title_color_hex_shortcode( $atts ) {
	$atts = shortcode_atts( array(
		'post_id' => get_the_ID(),
		'default' => 'light',
	), $atts );
...
add_shortcode( 'portfolio_title_color_hex', 'elementor_blank_portfolio_title_color_hex_shortcode' );
 ...
 */
function elementor_blank_if_title_color_shortcode( $atts, $content = null ) {
	$atts = shortcode_atts( array(
		'post_id' => get_the_ID(),
		'color'   => 'dark',
	), $atts );
...
add_shortcode( 'if_title_color', 'elementor_blank_if_title_color_shortcode' );

...
function elementor_blank_image_pan_zoom_shortcode($atts) {
    $atts = shortcode_atts([
        'image' => '',
        'zoom_min' => '1',
        'zoom_max' => '3',
...
add_shortcode('image_pan_zoom', 'elementor_blank_image_pan_zoom_shortcode');

function elementor_blank_enqueue_image_pan_zoom_assets() {
    wp_enqueue_style(
        'image-pan-zoom',
...
add_action('wp_enqueue_scripts', 'elementor_blank_enqueue_image_pan_zoom_assets');

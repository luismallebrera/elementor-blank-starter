 ...
 */
function elementor_blank_cleanup_municipio_provincias() {
    // Check if we've already run this cleanup
    if (get_option('elementor_blank_municipio_provincias_cleaned', false)) {
        return;
    }
    ...
    // Mark as cleaned
    update_option('elementor_blank_municipio_provincias_cleaned', true);
}
add_action('admin_init', 'elementor_blank_cleanup_municipio_provincias');
